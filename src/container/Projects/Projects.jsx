    ...
    <section id="projects" className="section">
      <div className="section__container">
        ...
        <div className="projects-container">
          <ProjectContainer icon="document-text" iconcolor="#FFE278" host="https://nahuelgenchi.github.io/notes/" github="https://github.com/NahuelGenchi/notes.git" title="Notes App" desc="In this note app, users can easily add, edit, or delete their notes. The notes that had been added to this app will be stored in the browser's local storage so, they won't remove on page refresh or tab close."/>
